...
# Roberto Pablo Munoz in Santiago, Chile
# (https://github.com/rpmunoz/DECam).

""">> make_rgb << create an RGB image from FITS files <rmunoz@uc.cl>
Usage: make_rgb [options] FITS_files
...
def main(argv):
	"Create a RGB color image from a set of FITS files"
